...
#include "box.h"
#include "ray.h"
//we creaate octree only once at setup and initialize
//if you implement subdivide then you can create? in octree
// ignore getMeshFacesInBox, we only care about points
//
